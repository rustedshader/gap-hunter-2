...
# Force HuggingFace hub into fully offline mode so it never attempts a
# network connection to check for model updates. All Docling models are
# already cached at ~/.cache/huggingface/hub/ — no download is needed.
